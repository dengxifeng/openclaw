...
const CORE_PACKAGE_NAMES = new Set([DEFAULT_PACKAGE_NAME, "@dengxifeng/openclaw"]);
...
function normalizeTag(tag?: string) {
  return normalizePackageTagInput(tag, ["openclaw", "@dengxifeng/openclaw", DEFAULT_PACKAGE_NAME]) ?? "latest";
}
